...
class GramMSELoss(nn.Module):
    def forward(self, input, target):
        #print('input shapes:', GramMatrix()(input).size(), target.size())
...
img_names = ['signac.jpg', 'Heidelberg-640x427.jpg']
...
"""
# generate a random image for texture synthesis
...
for i in range(5):
    ...
    numpy_style_targets.dump('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/gram/rainprincess/lr/5_jpg_relu'+str(i+1)+'_1')
...
for counter in range(5):
    style_gram_ = np.load('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/gram/rainprincess/lr/12345jpg_min_relu'+str(counter+1)+'_1')
...
imsave('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/outputs/signacjpg_Heidelberg.png', out_img)
...
for i in range(5):
    numpy_style_targets =  np.squeeze(style_targets[i].data.cpu().numpy(), axis=(0,))
    numpy_style_targets.dump('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/gram/rainprincess/hr/5_jpg_relu'+str(i+1)+'_1')
    print('style_targets shape:', numpy_style_targets.shape)
    print('\n')
print('\n')
...
style_targets_ = []
for counter in range(5):
    style_gram_ = np.load('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/gram/rainprincess/hr/12345jpg_min_relu'+str(counter+1)+'_1')
    style_gram = np.expand_dims(style_gram_, axis=0)
    style_gram = style_gram.astype(int)
    style_gram = Variable(torch.cuda.FloatTensor(style_gram))
    style_targets_.append(style_gram)
...
imsave('/export/home/amanila/00_thesis/00_pytorch_neuralstyletransfer/PytorchNeuralStyleTransfer/outputs/signacjpg_Heidelberg_hr200.png', out_img_hr)
